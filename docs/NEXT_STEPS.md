...
3. Toegestane bron-naar-doel-koppelingen, zoals `LOG → LEX`, configureerbaar
   maken.
4. Algemene host- en scoperegels als afzonderlijke Voorconfig uitwerken.
5. Een editor toevoegen voor LOG-majors, intervallen en klassekoppelingen.
6. De voorbeeldvalidator expliciet laten melden wanneer surface en
   LOG→LEX→Wissel-afleiding afwijken.
7. De fallback bij niet-aangrenzende `after/before`-paren in de UI
   visualiseren.
8. Meer minorbreedtes dan één onderzoeken voor samengestelde domeinen.
