...
> **Source build 20260813.5:** naast de Language Tree bestaat nu de berekende
> toepassing Anafoor · multi-OGN. S1 en S2 worden afzonderlijk berekend en
> daarna star gecomponeerd; S1 staat boven S2, MAN en HIJ delen als enige
> gedeclareerde kruis-OGN-kolom, en één gezamenlijke LEX-as ordent S1 vóór S2.
> Zie `MULTI_OGN_ANAPHOR.md`.
