...
Vanaf v4414 is `docs/index.html` verwijderd en heet de documentatie-startpagina `docs/docs-home.html`. Daardoor kan een unzip/publicatieproces de root `index.html` niet meer met de docs-index verwarren. `viewer.html` is een fallback-entry voor de viewer.
