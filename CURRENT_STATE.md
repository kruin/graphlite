...
## Carousel-uitleglaag (v4497)

De map `carousel/` bevat de stapbare uitlegbeelden. Gebruik `carousel/index.html?v4497` voor de didactische route; de viewer zelf blijft de interactieve testlaag voor assen, groei, vrije slots en projecties.
...
## v4497 · gridvenster en rechterkolom
...
## v4497 · Main-controls in venster
