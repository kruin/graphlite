...
De release is aangeduid als `v2.0.9`. `VERSION.txt`, appbestanden, cachebestanden, manifest, actieve documentatie en lokale startlinks gebruiken dezelfde versie.
