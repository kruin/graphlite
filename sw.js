...
const OPENGRAPH_SW_VERSION = 'v3.1.0-rc.10-mobile-basic-menu-configurable-20260901.31-cleanup';
  ...
  event.waitUntil((async () => {
    ...
    try {
      ...
      for (const client of clients) {
        ...
        url.searchParams.set('source', 'v3.1.0-rc.10-mobile-basic-menu-configurable-20260901.31');
