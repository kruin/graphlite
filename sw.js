...
const OPENGRAPH_SW_VERSION = 'v2.0.0-rc.45-stable-catalog-scroll-reset-20260829.56-cleanup';
  ...
  event.waitUntil((async () => {
    ...
    try {
      ...
      for (const client of clients) {
        ...
        url.searchParams.set('source', 'v2.0.0-rc.45-stable-catalog-scroll-reset-20260829.56');
