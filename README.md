# OpenGraph Lite Viewer v4480

## v4480 — mobile portrait grid-first
...
## v4480 — carousel fix en documentatie-integratie

- Carousel laadt nu met cacheversies: `carousel/index.html?v4480`, `carousel.js?v4480` en `slides.json?v4480`.
...
## v4480 — mobile Play consistent boven
...
- Cacheversies bijgewerkt naar `v4480`.

# OpenGraph Lite Viewer — PWA v4480

## v4480 — mobile portrait Play-fix
...
- Cacheversie verhoogd naar `v4480`.
...
## v4480 · gridvenster bovenaan op alle platforms
