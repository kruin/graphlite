# OpenGraph Lite Viewer v4475

## v4475 — mobile portrait grid-first
...
## v4475 — carousel fix en documentatie-integratie

- Carousel laadt nu met cacheversies: `carousel/index.html?v4475`, `carousel.js?v4475` en `slides.json?v4475`.
...
## v4475 — mobile Play consistent boven
...
- Cacheversies bijgewerkt naar `v4475`.

# OpenGraph Lite Viewer — PWA v4475

## v4475 — mobile portrait Play-fix
...
- Cacheversie verhoogd naar `v4475`.
...
## v4475 · gridvenster bovenaan op alle platforms
...
## v4475 · portrait split grid/menu
