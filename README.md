...
## v4487 — carousel fix en documentatie-integratie

- Carousel laadt nu met cacheversies: `carousel/index.html?v4487`, `carousel.js?v4487` en `slides.json?v4487`.
...
## v4487 — mobile Play consistent boven
...
- Cacheversies bijgewerkt naar `v4487`.

# OpenGraph Lite Viewer — PWA v4487

## v4487 — mobile portrait Play-fix
...
- Cacheversie verhoogd naar `v4487`.
...
## v4487 · gridvenster bovenaan op alle platforms
