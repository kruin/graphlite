...
for f in ['id="mainSentenceMenu"','id="mainAdverbMenu"','id="mainViewMenu"','id="sourceAxisMenu"','id="mainExtraMenu"','data-source-axis="lex"','data-source-axis="synt"','data-source-axis="log"']:
...
for f in ['.compact-choice-menu > summary','.compact-choice-popover-wide','.main-control-select-compat','.main-extra-menu']:
