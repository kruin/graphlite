...
3. **Calculated → Anafoor · multi-OGN** bevat het vaste, alleen-lezen contract
   van de tweede berekende toepassing;
4. **Direct → Gedeeld** bevat uitsluitend bediening die Greedy Grow en Random
   werkelijk samen gebruiken;
5. **Direct → Greedy Grow** bevat uitsluitend de twee eigen Greedy-instellingen;
6. **Direct → Random** bevat uitsluitend de eigen Random-instellingen.
